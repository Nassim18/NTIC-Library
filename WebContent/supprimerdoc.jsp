...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Supprimer un Document</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleursupprimerdoc" method="post">

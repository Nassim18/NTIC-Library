...
<% pret p = (pret)session.getAttribute("sessionpret");%>
<div class="rooms">
	<div class="col-md-12">
		<img src="web/images/dpt.png" style="width:100%;">
	</div>
	<div class="container">
		<h3 style="margin-top: 300px;">Effectuer un pret</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/effectuerpret" method="post">
	        	  <div class="form-group">
				    <label for="name">ID-Copie</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></div>
				      <input type="text" class="form-control" name="copie" placeholder="cote" value=<%=p.getCopie()%>>
				    </div>
				  </div>
				  
 				<div class="form-group">
				    <label for="pname">ID-Réservation</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-info-sign"></span></div>
				      <input type="text" class="form-control" name="idres"  placeholder="Titre" value=<%=p.getIdres()%>>
				    </div>
				  </div>

				  <div class="form-group">
				    <label for="studentCard">ID-Adhérant</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
				      <input type="text" class="form-control" name="adh" placeholder="Auteur" value=<%=p.getNum()%>>
				    </div>
				  </div>

	        	  <div class="form-group">
				    <label for="adresse">Date Réservation</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-time"></span></div>
				      <input type="number" class="form-control" name="date" placeholder="Année"value=<%=p.getDate()%>>
				    </div>
				  </div>

				  <div class="form-group">
			        <input type="reset" class="btn btn-danger" value="Annuler"/>
			        <button type="submit" class="btn btn-success">Effectuer un prêt</button>
			      </div>
	        </form>
	</div>
</div>

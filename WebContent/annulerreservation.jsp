...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Annuler une réservation</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/contolleurannulerreservation"method="post">
	        	  <div class="form-group">
				    <label for="name">ID-Reservation</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></div>
				      <input type="text" class="form-control" name="id" placeholder="Cote">
				    </div>
				  </div>
				  
				  <div class="form-group">
			        <input type="reset" class="btn btn-danger" value="Annuler"/>
			        <button type="submit" class="btn btn-success">Annuler réservation</button>
			      </div>
	        </form>
	</div>
</div>

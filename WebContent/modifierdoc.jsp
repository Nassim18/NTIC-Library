...
<% document doc = (document)session.getAttribute("currentSessionDoc1");%>
<div class="rooms">
	<div class="col-md-12">
		<img src="web/images/dpt.png" style="width:100%;">
	</div>
	<div class="container">
		<h3 style="margin-top: 300px;">Modifier un Document</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurmodifierd" method="post">
	        	  <div class="form-group">
				    <label for="name">Cote</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></div>
				      <input type="text" class="form-control" name="cote" placeholder="Cote" value=<%=doc.getCote()%>>
				    </div>
				  </div>

				  <div class="form-group">
				    <label for="pname">Titre</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-info-sign"></span></div>
				      <input type="text" class="form-control" name="titre"  placeholder="Titre" value= <%=doc.getTitre()%>>
				    </div>
				  </div>

				  <div class="form-group">
				    <label for="studentCard">Auteur</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
				      <input type="text" class="form-control" name="auteur" placeholder="Auteur"value= <%=doc.getAuteur()%>>
				    </div>
				  </div>

	        	  <div class="form-group">
				    <label for="adresse">Année</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-time"></span></div>
				      <input type="number" class="form-control" name="annee" placeholder="Année"value= <%=doc.getAnnee()%>>
				    </div>
				  </div>


	        	  <div class="form-group">
				    <label for="email">spécialité</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-bookmark"></span></div>
				      <input type="text" class="form-control" name="specialite" placeholder="Spécialité"value= <%=doc.getSpecialite()%>>
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      ...
				      <input type="text" class="form-control" name="edition" placeholder="Edition"value= <%=doc.getEdition()%>>
				    </div>
				  </div>

				  <div class="form-group">
				    <label for="passwordConfirm">Catégorie</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-check"></span></div>
				      <input type="text" class="form-control" name="categorie" placeholder="Catégorie"value= <%=doc.getCategorie()%>>
				    </div>
				  </div>
				  <div class="form-group">

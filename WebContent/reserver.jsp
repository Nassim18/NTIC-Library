...
<html>
<head>
<title>Réserver un document</title>
<!-- for-mobile-apps -->
...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Réserver un Document</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurreserver" method="post">
				  ...
				  <div class="form-group">
				    <label for="studentCard">Num-Adhérant</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
				      <input type="text" class="form-control" name="numca" placeholder="Num-Adhérant">
				    </div>
				  </div>

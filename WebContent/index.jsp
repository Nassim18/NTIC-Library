...
<!-- Modal Search -->
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form action="http://localhost:8080/bibliotheque/controlleurrecherche" method="post">
          <div class="row">
	...
	<div class="row">
      <div class="col-lg-12">
           <p align="center">
          Titre : <input type="radio" value="op1" name="operation" >    Auteur : <input type="radio" value="op2" name="operation" >    Catégorie : <input type="radio" value="op3" name="operation" >
	<br>
	<br>
	<br>
  </p>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" onfocus="this.value = '';" name="critere" placeholder="Search for...">
            </div>

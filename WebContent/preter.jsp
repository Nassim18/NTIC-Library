...
<html>
<head>
<title>Prêter un document</title>
<!-- for-mobile-apps -->
...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Preter un document</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurpreter" method="post">
	        	  
				   <div class="form-group">
				    <label for="pname">ID-Adherant</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-info-sign"></span></div>
				      <input type="text" class="form-control" name="adh"  placeholder="Titre">
				    </div>
				  </div>

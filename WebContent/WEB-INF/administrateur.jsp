                            ...
                            <ul class="menu-content collapse in" id="menu-content">
                                ...
                                <li class="collapsed active" data-target="#new" data-toggle="collapse">
                                 ...
                                 <li class="collapsed" data-target="#new" data-toggle="collapse">
                                  <a href="traiter.jsp"><i class=""><img src="web/images/fa-user3.png" alt=""></i> <strong>Traiter demande d'adhésion </strong>  <span class="glyphicon glyphicon-chevron-right"></span></a>
                                  </li>

                                  <li class="collapsed" data-target="#new" data-toggle="collapse">
                                  <a href="#"><i class=""><img src="web/images/fa-user3.png" alt=""></i> <strong>Changer statu compte </strong>  <span class="glyphicon glyphicon-chevron-right"></span></a>
                                  </li>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h3><span class="glyphicon glyphicon-education"></span>  Soyez La bienvenue cher Administrateur</h3>
        </div>
					...
					<div class="login">
					  ...
					  <img src="web/images/user.png" width="200px" height="190px">
						...
						<div class="login-right1">
							<form>
								<h3 style=""><span class="glyphicon glyphicon-pushpin"></span>  ID administrateur :<%=user.getNumcarte() %></h3>
						   	   <p>

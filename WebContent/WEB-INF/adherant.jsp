                            ...
                            <ul class="menu-content collapse in" id="menu-content">
                                ...
                                <li class="collapsed active" data-target="#new" data-toggle="collapse">
                                  ...
                                  <a href="#"><i class=""><img src="web/images/fa-user2.png" alt=""></i> <strong>Gestion de réservations des documents </strong><span class="arrow"></span></a>
                                   ...
                                   <li><a href="reserver.jsp">Effectuer une réservation</a></li>
                                   <li><a href="annulerreservation.jsp">Annuler une réservation</a></li>
                                ...
                                <li class="collapsed" data-target="#new" data-toggle="collapse">
                                  <a href="#"><i class=""><img src="web/images/fa-user3.png" alt=""></i> <strong>Demander quitus </strong>  <span class="glyphicon glyphicon-chevron-right"></span></a>
                                </li>
                                
                
                
                                 <li class="collapsed" data-target="#new" data-toggle="collapse">
                                  <a href="#"><i class=""><img src="web/images/fa-user3.png" alt=""></i> <strong>Imprimer quitus </strong>  <span class="glyphicon glyphicon-chevron-right"></span></a>
                                  </li>


                                  <li class="collapsed" data-target="#new" data-toggle="collapse">
                                  <a href="#"><i class=""><img src="web/images/fa-user3.png" alt=""></i> <strong>Demander ré-adhésion </strong>  <span class="glyphicon glyphicon-chevron-right"></span></a>
                                </li>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h3><span class="glyphicon glyphicon-education"></span>  Soyez La bienvenue cher Adhérant</h3>
        </div>
					...
					<div class="login">
					  ...
					  <img src="web/images/user.png" width="200px" height="190px">
						...
						<div class="login-right1">
							<form>
								<h3 style=""><span class="glyphicon glyphicon-pushpin"></span>  ID adhérant :<%=user.getNumcarte() %> </h3>
						   	   <p>
                            <h3 style=""><span class="glyphicon glyphicon-user"></span>  Username :<%=user.getUsername() %> </h3>
                            <br />
                            <h3 style=""><span class="glyphicon glyphicon-info-sign"></span>  Nom :<%=user.getNom() %></h3>
                            <br />
                            <h3 style=""><span class="glyphicon glyphicon-info-sign"></span>  Prénom :<%=user.getPrenom() %></h3>
                               </p>	
                               <form>

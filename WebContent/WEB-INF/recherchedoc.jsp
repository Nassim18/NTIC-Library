...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Résultats de la recherche </h3>
		...
		while (i.hasNext()){
			document d = new document();
				...
				<h4><label>auteur document    :</label>		<%out.println(d.getAuteur());%></h4>
			 	<h4><label>édition document   :</label>		<%out.println(d.getEdition());%></h4>
				<h4><label>spécialité document:</label>		<%out.println(d.getSpecialite());%></h4>
				<h4><label>catégorie document :</label>		<%out.println(d.getCategorie());%>  </h4>

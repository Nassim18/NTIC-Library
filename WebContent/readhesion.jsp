...
<html>
<head>
<title>Demande de ré-adhésion</title>
<!-- for-mobile-apps -->
...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Formulaire de Ré-adhésion </h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurdemandereadhesion" method="post">
				  ...
				  <div class="form-group">
				    <label for="pname">Specialité</label>
				    <div class="input-group">
				  ...
				  <div class="form-group">
				    <label for="studentCard">N°carte d'adhésion</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-credit-card"></span></div>
				      <input type="text" class="form-control" name="num_ca" placeholder="Num de carte d'adhésion">
				    </div>
				  </div>

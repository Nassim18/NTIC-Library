...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Traiter les demandes d'adhésions</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurtraiteradhesion" method="post">

...
<div class="rooms">
	...
	<div class="container">
		<h3 style="margin-top: 300px;">Inscription</h3>
		<form class="col-md-6 col-md-offset-3" action="http://localhost:8080/bibliotheque/controlleurinscription" method="post">
				  ...
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
				      <input type="text" name = "prenom" class="form-control" id="pname" placeholder="Prénom">
				    </div>
				  </div>

				  <div class="form-group">
				    <label for="studentCard">N°carte professionnelle</label>
				    <div class="input-group">
				      <div class="input-group-addon"><span class="glyphicon glyphicon-credit-card"></span></div>
				      <input type="text" name="numcarte" class="form-control" id="studentCard" placeholder="Num de carte professionnelle">
				    </div>
				  </div>
	        	  ...
	        	  <div class="form-group">
				    ...
				    <div class="input-group">
				      ...
				      <input type="text" name = "adresse" class="form-control" id="address" placeholder="Adresse">
				    </div>
				  </div>
	        	  ...
	        	  <div class="form-group">
				    ...
				    <div class="input-group">
				      ...
				      <input type="text" name = "username" class="form-control" id="email" placeholder="Adresse éléctronique">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      ...
				      <input type="password" name="password" class="form-control" id="passwordConfirm" placeholder="Confirmer password">
				    </div>
				  </div>
				  <div class="form-group">
